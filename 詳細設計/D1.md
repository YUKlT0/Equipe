...
- **登録**
INSERT INTO customer (name, email, membership, user_date)
VALUES (?, ?, ?, CURRENT_TIMESTAMP);

- **参照**
SELECT user_id, name, email, membership, user_date
FROM customer
WHERE user_id = ?;
...
- **登録**
INSERT INTO admin (admin_name, email, password_hash, role)
VALUES (?, ?, ?, ?);

- **参照**
SELECT admin_id, admin_name, email, role
FROM admin
WHERE admin_id = ?;

- **更新**
UPDATE admin
SET admin_name = ?, email = ?, password_hash = ?, role = ?
WHERE admin_id = ?;
...
- **参照**
SELECT order_id, user_id, order_date, status, total_price
FROM orders
WHERE order_id = ?;
...
- **参照**
SELECT product_id, name, description, price, category_id
FROM product
WHERE product_id = ?;
...
- **参照**
SELECT product_image_id, product_id, image_url, alt_text
FROM product_image
