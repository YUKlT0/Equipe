...
classDiagram
    ...
    class ProductController {
        ...
        +getProductById(product_id): ProductDetail
    }
    ...
    class ProductRepository {
        ...
        +findWithCategoryAndImagesById(product_id): Optional~Product~
    }
    ...
    ProductService ..> ProductListItem : returns
    ProductService ..> ProductDetail : returns
...
classDiagram
    ...
    CartStorageStrategy <|.. DbCartStorage
    CartService ..> Cart
    Cart  <-- CartItem
